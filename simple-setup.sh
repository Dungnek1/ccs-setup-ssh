...
if ! command -v claude &> /dev/null; then
    ...
    echo "✅ Claude Code CLI already found"
fi
...
echo "CCS: $(which ccs || echo 'Not found')"
...
echo "2. nano ~/.ccs/*.settings.json"
echo "3. nano ~/.bashrc (find ANTHROPIC_API_KEY and ZAI_API_KEY)"
echo
